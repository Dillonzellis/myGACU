...
<head>
	...
	<title>MyGeorgia - EMV Cards</title>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">EMV Cards Coming Soon</h1>
          ...
          <div class="row">
              ...
              <p>MyGeorgia  Credit Union is committed to providing the highest level of secure options when  available. For that reason, we are pleased to inform you that MyGeorgia  Credit Union debit cards will now include the latest chip technology which provides  an added layer of security providing greater protection against fraud.</p>
              <p>When you use your new  card at a chip-activated terminal, the embedded chip protects your information  by creating a unique one-time code for each transactions. This helps prevent  stolen data from being fraudulently used.</p>
              <p>Here are some things  to know about your new chip card that is arriving soon: </p>
              <ul>
                <li><strong>Along with your new card you will also receive a  NEW PIN!</strong><br>
This PIN will arrive in the mail separate from the card, a few days  after your card arrives. <br>
                You will have to activate the card with the provided PIN, but you may  change the PIN at any MyGeorgia Neighborhood Branch. <br>
                **Each account holder will now have a separate card and PIN**</li>
              
                <li><strong>Your existing card will no longer work after June  30, 2016</strong><br>
One your NEW card has been activated, feel free to call us and verify  that your previous card has been permanently been disabled at 770-534-4255.</li>
              
                <li><strong>You will need to contact any merchant that has  your debit card stored and update your information with them directly. </strong></li>
              </ul>
              <p>Please note, it is still very important to  protect your card information as the chip does not protect against  card-not-present (online) fraud. Also, the same fraud risk still exists for  transactions processed with a merchant utilizing the magnetic stripe instead of  the chip. </p>
              <p>For more information  about the EMV chip card, please contact us at (770) 534-4255. </p>
<p>&nbsp;</p>
            </div>
              <!-- end span12 -->
