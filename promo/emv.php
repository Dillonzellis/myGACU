...
<?php include '../rightbtnsm.php';?>
    ...
    <iframe src="https://clickvue.com/emvcards/HALLCO0725.html" height="370" width="574" allowfullscreen="" frameborder="0" scrolling="no">
    </iframe>
</div>

              
              <p>MyGeorgia Credit Union will soon be issuing high-tech chip cards to all our cardholders. These new cards contain an embedded computer chip and are already in use in much of the rest of the world. Now they're becoming the standard in the U.S.</p>
              <p>Information programmed into your chip card will be personalized for your account and every in-person transaction is unique, adding a strong additional safeguard against fraud.</p>
              <p align="center" style="font-size:18px;"><strong>There is no need to request your chip card. We will be rolling them out soon!</strong><strong></strong></p>
              <p>&nbsp;</p>
            </div>
              <!-- end span12 -->
