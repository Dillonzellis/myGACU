	  ...
	  <div id="content">
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          <div class="row">
              ...
              <div class="span12">
              <p>It’s MyGeorgia’s policy to not share or provide private and sensitive information via email. Please do not include any account information in your message to us.</p>
                <form method="post" action="mailer1.php">
                        
					<p><label for="name">Name:</label> <input id="name" type="text" name="name" size="20" />
                                <br />
                                <br>
						<label for="email">Email:</label>
                          <input type="text" name="email" size="20" id="email" />
                                <br />
                                <br>
						<label for="words">Comments:</label>
