...
<head>
	...
	<title>MyGeorgia - Annual Meeting</title>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">Annual Meeting</h1>
                    
                </div><!-- en .span12 -->
            </div><!-- end .row -->
          <div class="row">
              <div class="span12"><p>The annual meeting is an occasion for management and elected officials to report to you, the owners of MyGeorgia. Take this opportunity to learn more about your credit union's financial position, products and services, current business issues, and goals!</p></div>
              <hr>
          </div><!-- end .row -->
          
          <div class="row">
              <div class="span6"><p align="center">All members are equal owners of the credit union, so we would like to invite you to participate in this years festivities. The entire credit union benefits when members participate!</p>
              <p align="center"><strong>Date:</strong> Thursday, May 26, 2016<br>
                  <strong>Location:</strong> Gainesville Civic Center Ballroom<br>
                <strong>Time:</strong> Registration begins at 5:30 p.m. (dinner provided)</p>
                <p align="center"><strong>Registration Deadline - May 12, 2016</strong></p>
              </div>
              <div class="span6">
                ...
                <form method="post" action="mailer2.php">
                        ...
                        <p>Name: <input type="text" name="name" size="20" />
                          ...
                          <input type="text" name="email" size="20" id="email" />
                                <br />
                                <br>
                          Yes! I will be attending the Annual Meeting with the following immediate family members:

<textarea name="words" cols="50" id="words"></textarea>
<br>
                                <br>
                        </p>
