		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">Savings</h1>
                    
                </div><!-- en .span12 -->
            </div><!-- end .row -->
            <div class="parallax" id="bg-parallax-4">
          <div class="row">
              <div class="span12">
              <p>We are owned by our members, so opening an account with MyGeorgia Credit Union makes you a part-owner of the credit union! Best Part- It's ONLY $5 to become a shareholder.</p>
              <p>Account Features:</p>
              <div class="vertical-tabs-container fixed">
                <ul class="tabs-menu fixed">
                    <li> <i class="ifc-money_bag"></i> <a href="https://www.mygacu.com#content-tab-2-1">Payroll</a> </li>
                    <li> <i class="ifc-money_bag"></i> <a href="https://www.mygacu.com#content-tab-2-2">ATM Card Access</a> </li>
                    <li> <i class="ifc-money_bag"></i> <a href="https://www.mygacu.com#content-tab-2-3">3 Withdrawals Per Month</a> </li>
                    <li> <i class="ifc-money_bag"></i> <a href="https://www.mygacu.com#content-tab-2-4">Quarterly Statements</a> </li>
                </ul>
                  <!-- end .tabs-menu -->
                  <div class="tabs">
                    <div class="tab-content" id="content-tab-2-1">
                      <p style="color:#003DA6;">Watch your savings grow by setting up money to go into your Base Share each payday.</p>
                    </div>
                    <!-- end .tab-content -->
                    <div class="tab-content" id="content-tab-2-2">
                      <p style="color:#003DA6;">With only $1 fee for each savings withdrawal.</p>
                    </div>
                    <!-- end .tab-content -->
                    <div class="tab-content" id="content-tab-2-3">
                      <p style="color:#003DA6;">Not only can you make a withdrawal from your account, but you can also transfer up to 6 times to another MyGeorgia account that you have with us!</p>
                    </div>
                    <!-- end .tab-content -->
                    <div class="tab-content" id="content-tab-2-4">
                      <p style="color:#003DA6;">Statements by mail or you can enroll in E-Statements.</p>
                      <ol style="color:#00A7E1;">
                        <li>Login to Online Banking</li>
                        <li>Click the Services Tab</li>
                        <li>Click the View Statements link</li>
                        <li>ENROLL!</li>
                      </ol>
                ...
                <p>*Federally Insured up to $250,000.</p>
                      <p>Please view our <a href="https://www.mygacu.com/rates/share.php">current rates</a> and <a href="https://www.mygacu.com/accounts/fees.php">fees</a>.</p>
				  <p><a href="https://www.mycreditunion.gov/life-events/planning-unexpected " onclick="drawAlert()" target="_blank">Click here</a> for tips on Planning for the  Unexpected.</p>
                      <p>&nbsp;</p>
                      <p>&nbsp;</p>
