    ...
    <div id="content">
      ...
      <div class="row">
        <div class="span12">
          ...
          <h1 class="text-uppercase">Fee Schedule</h1>

        </div><!-- en .span12 -->
      </div><!-- end .row -->
      <div class="row">
        <div class="span12">
          <p align="center"><strong>Effective February 1, 2022</strong></p>
          <p>The following fees may be assessed against your account and the following transaction limitations, if any, applied to your account. Fees could reduce earnings on the account.</p>
          <table border="0" cellpadding="0" cellspacing="0" align="center" style="width:95%;" role="presentation">
            <tr>
              <td>ATM/Debit Card Replacement Fee</td>
              <td>$10.00 (per card)</td>
            </tr>
            <tr>
              <td>Check Printing</td>
              <td>fee depends on style of checks ordered</td>
            </tr>
            <tr>
              <td>Low Balance Maintenance Fee<br>
                *(no fee if your average deposit balance is at least $50 or you have a loan)</td>
              <td>$5.00 monthly *Effective July 1, 2022(Monthly)</td>
            </tr>
            <tr>
              <td>Overdraft and Non-Sufficient Funds (NSF)</td>
              <td>$32.00 per item</td>
            </tr>
            <tr>
              <td>Overdraft Transfer Fee from Savings or Line of Credit</td>
              <td>$5.00</td>
            </tr>
            <tr>
              <td>Stop Payment</td>
            ...
            <tr>
              <td>Deposited Items Returned</td>
              <td>$15.00 per check</td>
            </tr>
            <tr>
              <td>Wire Transfer Outgoing (Domestic)</td>
              <td>$15.00</td>
            </tr>
            <tr>
              <td>Wire Transfer Incoming (Domestic)</td>
              <td>$10.00</td>
            </tr>
            <tr>
              <td>Wire Transfer Outgoing (International)</td>
              <td>$30.00</td>
            </tr>
            <tr>
              <td>Wire Transfer (Incoming) (International)</td>
              <td>$10.00</td>
            </tr>
            <tr>
              <td>Check Copy, Account Photocopy or Printout</td>
              <td>$2.00 per page</td>
            </tr>
            <tr>
              <td>ATM Transaction Fee with Savings only</td>
              <td>$1.00 per transaction</td>
            </tr>
            <tr>
              <td><strong>Savings Account</strong> Excess Withdrawal Fee for each withdrawal after 3 per month</td>
              <td>$5.00</td>
            </tr>
            <tr>
              <td><strong>Secured Checking</strong> Monthly Service Fee</td>
              <td>$10.00</td>
            </tr>
            <tr>
              <td><strong>Gold Checking</strong> Monthly Service Fee on balance below $1,500</td>
              <td>$5.00</td>
            </tr>
            <tr>
              <td><strong>Money Market Account</strong> Monthly Service Fee on balance below $2,000</td>
              <td>$10.00</td>
            </tr>
            <tr>
              <td><strong>Money Market Account</strong> Excessive Withdrawal Fee for each account debit after 6 per month.<br>
                (checks, transfers, cash, online...)</td>
              <td>$10.00</td>
            </tr>
            <tr>
              <td>Money Orders; $1,000 maximum check</td>
              <td>$1.00 per check</td>
            </tr>
            <tr>
              <td><strong>Christmas &amp; Vacation Club Account</strong> Excessive Withdrawal Fee after 1 free per year</td>
              <td>$25.00</td>
            </tr>
            <tr>
              <td>Garnishments, Executions, Levies</td>
              <td>$51.00 per occurrence</td>
            </tr>
            <tr>
              <td>Account Research and Balancing Fee</td>
              <td>$10.00 hourly charge</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Dormant Account Fee after 24 months of inactivity</td>
              <td>$20.00 per year</td>
            </tr>
            <tr>
              <td>Notary Service (non-member)</td>
              <td>$1.00</td>
            </tr>
          </table>
          <p>&nbsp;</p>
