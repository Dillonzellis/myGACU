...
<head>
	...
	<title>MyGeorgia - Money Market</title>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">Money Market</h1>
                    
                </div><!-- en .span12 -->
            </div><!-- end .row -->
          <div class="row">
              <div class="span8">
              <p> Money Market accounts have more flexibility than a traditional savings accounts and potentially much better interest rates. A MyGeorgia money market account assists our members with building wealth without the risk!</p>
              <ul>
              <li>Competitive <strong><a href="https://www.mygacu.com/rates/share.php">interest rate</a></strong> paid MONTHLY! (as your account grows, so does your rate)</li>
              <li>NCUA insured up to $250,000</li>
              <li>First 50 checks FREE!</li>
              <li>6 withdrawals per month</li>
              <li>Great Alternative to long term CD's</li>
              </ul>
              <p>Please see our <a href="https://www.mygacu.com/accounts/fees.php" title="Fee Statement">Fee Statement</a> for any applicable fees or contact us for more information about our money market accounts.</p>
              </div>
              <!-- end span8 -->
              
              <div class="span4">
              <p align="center"><img src="https://www.mygacu.com/_content/moneymarket.png" alt="Financial guidance" border="0"></p>
              </div>
              <!-- end span4 -->
