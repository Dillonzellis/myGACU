...
<head>
	...
	<title>MyGeorgia - Credit Card</title>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">Credit card</h1>
                    
                </div><!-- en .span12 -->
            </div><!-- end .row -->
          <div class="parallax" id="bg-parallax-10">
          <div class="row">
              
              <div class="span12">
                <p>Whether planning a vacation, furnishing a new home or purchasing a new wardrobe, a credit card can prove a convenient way to access money quickly. At MyGeorgia Credit Union, we are proud to offer VISA Platinum, VISA Classic, and VISA Secured* credit cards to our members. Once approved to become a VISA cardholder, we highly recommend that you link your card to the MyGeorgia Mobile App. There, you can control access to your VISA card for heightened fraud protection and the ultimate in convenience.</p>
                <p><strong>Additional benefits of becoming a MyGeorgia VISA cardholder include:</strong></p>
                <ul>
                <li>No annual fee</li>
                <li>Secured and unsecured rate</li>
                <li>25-day grace period</li>
                <li>No transaction fee on balance transfers from your credit union (interest accrues from the day of the advance)</li>
				<li>SCORECARD® Rewards Program. Use the MyGeorgia Credit Card for all purchases and enjoy your rewards. <a href=" https://www.mygacu.com/services/myrewards.php" target="_blank">Click here</a> for more details and to view rewards.</li>
                </ul>
                <p><em>*Secured Visa&reg; - Credit card limit is secured by savings deposit to help member re-establish credit.</em></p>
                <p><em>Terms and conditions subject to change without notice.</em></p>
                <p>&nbsp;</p>
                <p align="center" style="font-size:20px;"><a href="https://www.mygacu.com/loans/visa_disclosures.php">Click here</a> for a full credit card disclosure. (see this proof at the end of document)</p>
                <p align="center" style="font-size:20px;"><br>
                <a href="https://www.mobicint.net/hco/login/loanapp">Click here</a> to apply!</p>
                <p align="center"><iframe width="560" height="315" src="https://www.youtube.com/embed/X7OFLkGjxgs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
              </div>
              <!-- end .span12 -->
