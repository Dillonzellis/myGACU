...
<head>
	...
	<title>MyGeorgia - Home Loans</title>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">Home Loans</h1>
          ...
          <div class="row">
              ...
              <div class="span8">
				  <p>Are  you searching for a QUICK, EASY &amp; LOCAL process for a new Mortgage or  Refinance Loan? MyGeorgia IS YOUR SOLUTION.&nbsp;</p>
                <p>We provide all of the credit union benefits to individuals who live or work in a 12-county region that includes Banks, Dawson, Habersham, Hall, Jackson, Lumpkin, Rabun, White, Clarke, Madison, Oconee, and Oglethorpe Counties.</p>
                  <p>Call 770-534-4255  and ask for your LOCAL Mortgage Specialist.				  </p>
                  <h2 style="color:#4b5759;"><strong>Home Purchase or Refinance</strong></h2>
			    <p>With the help of <a href="https://www.mygacu.com/message/cufs.php" target="_blank" style="color:blue">Credit Union Financial Services (CUFS)</a>, MyGeorgia offers a wide range of first mortgage loans – including Conventional, FHA, ARM, USDA, and VA.</p>
                <p>Of course, with interest rates at such historically low levels, our in-house mortgage program might be the right choice for you!  Your family could be mortgage free in just 10-15 years. </p>
				  <p>The benefits of a short-term mortgage include:</p>
			    <ul><strong>
                 <li>Up to 15-year terms</li>
                 <li>Low Rates</li>
                  <li>Dramatically lower closing costs</li>
                  <li>No private mortgage insurance (PMI)</li>
			    <li>Payments made directly to MyGeorgia</li></strong></ul>
                <p>  To learn more about these mortgage products, contact a MyGeorgia loan specialist today at 770-534-4255. <a href="https://www.mycreditunion.gov/life-events/home-ownership " onclick="drawAlert()" target="_blank">Click here</a>  for tips on purchasing a home.
              </p>
              </div>
              <!-- end .span8 -->
              
              <div class="span4">
                <p align="center"><img src="https://www.mygacu.com/_content/homeloans.png" alt="Happy family" border="0"></p>
                <p>&nbsp;</p>
              </div>
              <!-- end .span4 -->
              ...
              <div class="span8">
				   <h2 style="color:#4b5759;"><strong>Second Mortgages</strong></h2>
                      <p>A second mortgage – or Home Equity Line of Credit (HELOC) provides an excellent way to borrow against the equity you’ve already established through your first mortgage to finance a renovation project, purchase a vacation home, consolidate debt and more.</p>
                    
                      <p><strong>Wait…it gets better!  Second mortgages feature:</strong></p>
                      <ul>
                     <strong> <li>No closing costs on HELOC (Appraisal fee may be required)</li>
                      <li>Minimal $400 - $600 closing costs for Second Mortgage (Appraisal fee may be required)</li>
                      <li>Borrow up to 90% of the appraised value or 110% of the Tax Assessment (less the balance of your first mortgage.)</li>
                      <li>All loans over $75,000 require an appraisal</li>
					  <li>Fixed and variable rates available</li>
				      <li>In-house closing available</li></strong>
					  </ul>
						<p><em>Terms and conditions subject to change without notice.</em></p>
						
				<p><strong>To apply for a second mortgage, contact a loan specialist today!  770-534-4255. 	</strong></p>
				  <p><a href="https://www.mycreditunion.gov/life-events/home-ownership " onclick="drawAlert()" target="_blank">Click here</a>  for tips on purchasing a home.</p>
              ...
              <div class="span4">
                <p align="center"><img src="https://www.mygacu.com/_content/secondmort.png" alt="Happy family" border="0"></p>
                <p>&nbsp;</p>
              </div>
              <!-- end .span4 -->
		 ...
		 <p align="center"><iframe width="560" height="315" src="https://www.youtube.com/embed/yuQM3IK6GvA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>
