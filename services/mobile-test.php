...
<head>
	...
	<title>MyGeorgia - Mobile Banking</title>
...
<link href='https://fonts.googleapis.com/css?family=kanit' rel='stylesheet'> <link rel="stylesheet" href="../_layout/css/base.css"> <link rel="stylesheet" href="../_layout/css/grid.css"> <link rel="stylesheet" href="../_layout/css/elements.css"> <link rel="stylesheet" href="../_layout/css/layout.css">
    ...
    <!-- load projekktor -->
    <script type="text/javascript" src="projekktor-1.2.26r246.min.js"></script>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">Mobile/Online Banking</h1>
                    
                </div><!-- en .span12 -->
            </div><!-- end .row -->
            
            <div class="parallax" id="bg-parallax-7">
          <div class="row">
              <div class="span8">
              
              <h2 style="color:#4b5759;">NEW Mobile Deposits</h2>
              <p>Here we go again, Helping You Afford Life!  Now you can deposit checks using your smartphone, anywhere, anytime.  Simply download the MyGeorgia App from Google Play or iTunes.  We only require that you be enrolled in Electronic Statements, your account opened for 30 days, and your in good standing with the credit union.  That's it.</p>
              <p>Our online banking service is called <strong>Online Banking</strong>. It's a simple way for you to access your account securely, anytime from a smartphone, computer or tablet. Download MyGeorgia's App from Google Play Store or iTunes App Store. With Mobile &amp; PC Banking you can:</p>
              <ul>
              <li>View Balance</li>
              <li>View History</li>
              <li>View Checks Cleared</li>
              <li>Remote Control Debit Cards</li>
              <li>Transfer Funds</li>
              <li>Pay Bills</li>
              <li>View E-Statements</li>
              <li>Set up Low Balance E-Alerts</li>
              <li>Contact Us</li>
              <li>See Payroll before it posts</li>
              <li>Mobile Deposit</li>
              <li>It's Free!</li>
              </ul>
    
              <p align="center" style="font-size:18px;"><strong>Contact us to get your USERNAME.</strong></p>
              <p align="center" style="font-size:18px;"><a href="https://itunes.apple.com/us/app/hallco-community-credit-union/id716700913?ls=1&mt=8" target="_blank"><img src="../_layout/images/itunes.png" alt="App Store" width="133" height="44" title="App Store"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://play.google.com/store/apps/details?id=com.cmcflex.ftmobile.hco" target="_blank"><img src="../_layout/images/googleplay.png" alt="Google Play" title="Google Play" border="0"></a></p>
              ...
              <div class="span4">
              <p>&nbsp;</p>
              <p align="center"><video id="player_a" class="projekktor" poster="mobilebanking.png" title="Mobile Banking" width="320" height="240" controls>
        <source src="mobilebanking.ogv" type="video/ogg" />
        <source src="mobilebanking.mp4" type="video/mp4" />
        <source src="mobilebanking.webm" type="video/webm" />
    </video>
