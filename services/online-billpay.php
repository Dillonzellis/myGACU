...
<head>
	...
	<title>MyGeorgia - Online Bill Pay</title>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">Online Bill Pay</h1>
          ...
          <div class="row">
              ...
              <p>Online bill pay service is a convenient way for you to pay all of your bills from our secure website. It can save you time and money. Simply login to your  online banking account, click on the Services tab, then click on Pay Your Bills to get started. Here's why you should try it:</p>
              <p><a href="https://www.billpaysite.com/V2/GuidedConsumerDemo/Enrollment/demo.aspx?instID=39392&MkPromo=0&MkRec=1462030" target="_blank" onclick="drawAlert()"><img src="../_content/bill_pay2.jpg" border="0" align="right" style="padding-left:25px;"></a><STRONG>Security</STRONG><BR>
You don&rsquo;t have to worry about someone stealing your identity by sending  personal checks by mail.</p>
              <p><STRONG>Time</STRONG><BR>
                In what little time you have, do you really want to spend it writing out  numerous checks? Online bill pay lets you pay your bills in minutes, literally.  You can pay your first bill in two simple steps:</p>
              <p>Add a Payee (any merchant or  person you need to pay) and schedule a payment.</p>
              <p><STRONG>Convenience</STRONG><BR>
                Online bill pay is a great time and money management tool. It allows you to pay  all of your bills from our secure network. There&rsquo;s no remembering multiple  passwords and jumping around to multiple websites to pay your bills. Plus, it  integrates with your online banking account to give you complete history of  your account.</p>
              <p><STRONG>Saving</STRONG><BR>
                Every little bit of saving helps, right? When estimating the cost of personal  checks, envelopes, stamps, and trips to the post office, some studies suggest  you can save up to $150 each year using online bill pay.</p>
Simplify  your life by trying online bill pay. Contact one of our officers for more  details and get started today!              </div>
              <!-- end span12 -->
