...
<head>
	...
	<title>MyGeorgia - E-Statements</title>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">Member-to-Member Transfers</h1>
          ...
          <div class="row">
              ...
              <p>Now  available through desktop and mobile apps - our members can transfer money to  friends, family, co-workers, and others for free!<br>
You do not  have to be an owner/co-owner of the account.</p>
              <p>To make a  transfer, you will have to know the member account number, the three-digit  suffix (011, etc.) and the correct spelling of the member&rsquo;s last name. This  will be a one-way transfer and cannot be reversed through the application.</p>
              <p><em>MyGeorgia cannot  provide member account information to the party making the transfer.</em></p>
              <p>Member-to-Member  payments are just as easy as transferring from one suffix to another.</p>
              <ul>
                <ul class="circle">
                  <li>Simply  scrolls down to the bottom of the &lsquo;<u>Transfer To Suffix List&rsquo;</u></li>
                  <li>Find&nbsp;  &lsquo;<u>Other</u>&rsquo;&nbsp; or &nbsp;&ldquo;<u>Other Account</u>&rsquo;&nbsp; or&nbsp; &lsquo;<u>Another  Member Account</u>&rsquo;</li>
                </ul>
              </ul>
              <p>*The  wording varies based on device.</p>
              <p>The  transfer is complete, and the funds are available immediately.</p>
<p><img src="../_content/index/Screenshot1.png" width="468" height="485"><img src="../_content/index/Screenshot2.png" width="300" height="485" alt=""/><img src="../_content/index/Screenshot3.png" width="300" height="485" alt=""/></p>
            </div>
              <!-- end span12 -->
