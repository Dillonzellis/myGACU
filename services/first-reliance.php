...
<head>
	...
	<title>MyGeorgia - First Reliance Members</title>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">First Reliance Members</h1>
                    
                </div><!-- en .span12 -->
            </div><!-- end .row -->
          <div class="row">
              <div class="span12">
              <p><strong>Debit Cards:</strong>  Activate your new MyGeorgia Credit Union Debit Card by calling 1-800-472-3272; You’ll be prompted to verify your personal information and then you will select your PIN.</p>
				  
				  <p><strong>Online/Mobile Banking:</strong>  You may sign in to Online Banking from the website or Download the MyGAcu Mobile App from the app store <img src="https://www.mygacu.com/_layout/images/myGaApp.jpg" alt="MyGa Mobile App" style="vertical-align: middle; max-width: 45px;">.<br> Utilize your old First Reliance member number as your Username and click Forgot Password.</p>
				  
				  <p><strong>Credit Cards:</strong>  For now, continue to use your existing FRFCU credit card and check your credit card balance on <a href="http://www.ezcardinfo.com/" onclick="drawAlert()" target="_blank">www.ezcardinfo.com</a>.  Later this month, you will receive a new MyGeorgia Credit Card that will replace your First Reliance Credit Card.  Once you activate and begin using the new MyGeorgia Credit Card, you will be able to view your credit card balance and transaction history within the Online Banking and Mobile App.</p>
