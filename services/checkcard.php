		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">MasterCard Debit Cards</h1>
                    
                </div><!-- en .span12 -->
            </div><!-- end .row -->
          <div class="row">
              <div class="span12">
              <h2>Remote Control Debit Cards</h2>
              <p><img src="../_content/phone.png" border="0" align="right" style="padding-left:25px;">We're always looking for ways to Help You Afford Life and protect you against fraud. Here are a few ways we protect your checking account and debit card:</p>
              <ul>
              <li><strong>Turn your Debit Card Off &amp; On with our Mobile App</strong><br>
If you suspect fraud, lost your card, or simply don't need your debit card for a while, turn it off! Turn it on when ever you need it again. It's Real-Time fraud protection.</li>
              <li><strong>Sign up for Low Balance Alerts</strong><br>
                We'll remind you if your balance is getting low.
              </li>
              <li><strong>PC &amp; Mobile 24/7 Balance Access</strong><br>
                Check your balance anytime, anywhere.
              </li>
              <li><strong>Continuous Transaction Monitoring</strong><br>
                We'll let you know if there are any suspicious transactions on your account.</li>
              </ul>
              <p>Our Debit Card combines the economy of a checking account with the convenience and versatility of a credit card. Your card works at millions of locations that accept Debit Cards. Your Debit Card draws money from your checking account, so no interest charges apply (ATM charges may apply).</p>
              <p>The Debit Card is only available with our Checking accounts.</p>
              <p>Please <a href="https://www.mygacu.com/siteinfo/contact.php">contact us</a> if you have any other questions about the MasterCard Debit Cards. Call (800) 262-2024 to report your card lost or stolen.</p>
            </div>
              <!-- end span12 -->
