...
<head>
	...
	<title>MyGeorgia - TruStage Insurance</title>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span12">
                    ...
                    <h1 class="text-uppercase">TruStage&trade; Auto &amp; Home Insurance Program</h1>
          ...
          <div class="row">
              <div class="span12">
				  ...
				  <p><strong>MyGeorgia Credit Union Members Could Save Hundreds on Car Insurance</strong></p>
				  <p>If you haven't gotten a car insurance quote lately, your credit union membership could help you save hundreds of dollars.</p>
				  <p>MyGeorgia Credit Union members may qualify for discounts on car insurance through the TruStage Auto Insurance Program. You could save big, and it can be easy to switch carriers - without losing any money.</p>
				  <p>TruStage offers a powerful mix of savings and popular, member-friendly benefits:</p>
				  
				  <ul>
					  <li>Credit union member discounts</li>
					  <li>Nationally recognized companies</li>
					  <li>Friendly, 24/7 service - even on holidays</li>
					  <li>Discounts for multiple vehicles, safety features, good driving and more</li>
					  <li>Mobile app for easy claims</li>
				  </ul>
				  
				  <p>It can be easy to get a free quote today. Don't wait to see how much you could save.</p>
				  
				  <p><strong>A Tradition of Strength</strong></p>
				  <p>TruStage is part of a heritage of faithful service to credit union members spanning more than 80 years. Over 17 million people have selected TruStage for AD&D, life, auto & home insurance and more.</p>
				  <p><em>TruStage® Auto Insurance program is offered by TruStage Insurance Agency, LLC and issued by leading insurance companies. Discounts are not available in all states and discounts vary by state. The insurance offered is not a deposit and is not federally insured. This coverage is not sold or guaranteed by your credit union.</em></p>

				  <p align="center"><a href="https://www.trustage.com/auto-home/save-on-car-insurance" onclick="drawAlert()" target="_blank"><img src="../_content/trustage.jpg" width="728" height="90" alt="TruStage Auto &amp; Home Insurance"/></a></p>
            </div>
              <!-- end span12 -->
